...
Floop.prototype.send_ = function(name, msg, cb, context) {
  var str;
...
Floop.prototype.disconnect_ = function(msg) {
  if (!this.conn) {
    return msg;
  }
...
Floop.prototype.data_handler_ = function (d) {
  var args, f, msg,
    newline_index;
...
Floop.prototype.handle_msg = function (msg) {
  var self = this;
...
Floop.prototype.connect_ = function (host, port, cb) {
  var self = this,
    options;
