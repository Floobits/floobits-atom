...
MugShot.prototype.snapshot = function () {
  ...
  webrtcAction.get_constraints("video", constraints, function (err, constraints) {
    getUserMedia(constraints, _.bind(this.gotUserMedia, this));
  }.bind(this));
};
...
MugShot.prototype.gotUserMedia = function (err, stream) {
  ...
  if (this.stream) {
    console.warn("Mug shot stream already exists! Killing old stream");
    try {
      this.stream.stop();
    } catch (e) {
