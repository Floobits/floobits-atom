...
Buffer.prototype.cleanUp = function () {
...
const Buffers = flux.createCollection({
  ...
  on_patch: function (data) {
    ...
    bufferAction.changed(buf, charPointer, patches.patches);
  ...
  on_delete_buf: function (d) {
    ...
    bufferAction.deleted(b, d.force);
  },
  add: function (d) {
    this.super_.prototype.add.call(this, d);
    this.paths_to_ids[d.path] = d.id;
    bufferAction.created(this.get(d.id), d.username);
  },
  start: function () {
