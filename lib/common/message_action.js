...
Actions = flux.createActions({
  ...
  info: function (msg) {
    return this.log(msg, messagesModel.LEVEL.INFO);
  },
  success: function (msg) {
    return this.log(msg, messagesModel.LEVEL.SUCCESS);
  },
  warn: function (msg) {
    return this.log(msg, messagesModel.LEVEL.WARNING);
  },
  error: function (msg) {
    return this.log(msg, messagesModel.LEVEL.ERROR);
  },
  modal: function (msg) {
    return msg;
  },
