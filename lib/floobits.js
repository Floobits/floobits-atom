...
module.exports = {
  ...
  on_room_info: function (workspace) {
    ...
    this.atom_listener.start(workspace);
  ...
  start: function (floourl, url, created, path) {
    const that = this;
    that.leave_workspace();
    ...
    that.handler = new FlooHandler(path, floourl, that.me, that.users, that.bufs, that.filetree, created);
