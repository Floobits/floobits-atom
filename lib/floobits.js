...
module.exports = {
  ...
  activate: function (state) {
    ...
    var Component = require("./build/join.js");
    var modal = create_node("asdf", Component(), ".floobits {color: red}")
  ...
  join_workspace: function () {
    var dotFloo, url, root = atom.project.getRootDirectory();

    if (root) {
      dotFloo = utils.load_floo(root.path);
      url = dotFloo.url;
      this.join_workspace_(root.path, url);
    }
  },
