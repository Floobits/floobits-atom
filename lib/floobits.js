...
module.exports = {
  ...
  open_chat: function () {
    ...
    const MessagesView = require("./build/messages_view");
    const chatView = new MessagesView({messages: require("./common/message_model").Messages, username: this.me.id, focus: true});
