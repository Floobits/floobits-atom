...
FlooHandler.prototype.start = function () {
  ...
  listener.start(this.bufs, this.users);

  atom.workspace.eachEditor(function (editor) {
    self.editors[editor.buffer.getPath()] = editor;
  });

  listener.onEDITOR_CREATED(function (editor) {

  }, this);

  listener.onEDITOR_DESTROYED(function (editor) {

  }, this);

  listener.onCHANGED(this.atom_changed, this);
  listener.onSTOPPED_CHANGING(this.atom_stopped_changing, this);
  listener.onSAVED(this.atom_saved.bind, this);
  listener.onCHANGED_SELECTION(this.atom_selected, this);
  // listener.onCHANGED_CURSOR(this.atom_selected.bind(this));
  listener.onCHANGED_PATH(this.atom_renamed, this);
