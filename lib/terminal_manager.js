...
TerminalManager.prototype.createTerm = function () {
  ...
  Socket.onCREATE_TERM(function (req) {
    ...
    termView.ptyProcess.on("term2:data", function (d) {
      console.log('pty', d);
    ...
    //   }
    //   try {
    //     termView.term.write(new Buffer(data.data, "base64").toString("utf-8"));
    //     // termView.ptyProcess.send({event: 'input', text: new Buffer(data.data, "base64").toString("utf-8")});
    //   } catch (e) {
    //     console.warn(e);
    //   }
    // }, this);
